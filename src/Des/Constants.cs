namespace Des
{
  ...
  {
    public const int SizeOfBlock = 64;  // Unicode=16, 4 symbols
    public const int SizeOfChar = 16;   // Unicode=16
    public const int LengthOfBlock = SizeOfBlock / SizeOfChar;
    public const int QuantityOfRounds = 16;

    public static readonly int[] ETable =
    {
      32,  1,  2,  3,  4,  5,
       4,  5,  6,  7,  8,  9,
       8,  9, 10, 11, 12, 13,
    ...
    public static readonly int[] PTable =
    {
    ...
    public static readonly int[] IpTable =
    {
    ...
    public static readonly int[] IpReversedTable =
    {
    ...
    public static readonly int[] KeyIpTable =
    {
    ...
    public static readonly int[] IthKeyTable =
    {
    ...
    public static readonly int[][][] STables =
    {
      new[]
      {
